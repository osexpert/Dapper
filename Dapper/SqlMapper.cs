...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        internal static string GetInListRegex(string name, bool byPosition) => byPosition
        ...
        public static void PackListParameters(IDbCommand command, string namePrefix, object value)
        {
            ...
            else
            {
                ...
                bool handled = false;
                foreach (var h in Settings.InListCustomHandlers)
                {
                    if (h.TryHandle(command, namePrefix, byPosition, ref list))
                    {
                        handled = true;
                        break;
                    }
